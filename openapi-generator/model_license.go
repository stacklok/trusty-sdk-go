...
func (o *License) GetClaims() []LicenseClaim {
	if o == nil || IsNil(o.Claims) {
		var ret []LicenseClaim
		return ret
	}
	return o.Claims
}
...
func (o *License) GetClaimsOk() ([]LicenseClaim, bool) {
	if o == nil || IsNil(o.Claims) {
		return nil, false
	}
...
// SetClaims gets a reference to the given []LicenseClaim and assigns it to the Claims field.
func (o *License) SetClaims(v []LicenseClaim) {
	o.Claims = v
}
...
func (o *License) SetLicenseNil() {
	o.License.Set(nil)
}

// UnsetLicense ensures that no value is present for License, not even an explicit nil
func (o *License) UnsetLicense() {
	o.License.Unset()
}
